...
class appserver::params {
  ...
  $stratos_instance_data_host_name ='as.wso2.com'
  $stratos_instance_mgt_host_name ='mgt.as.wso2.com'
  $puppet_master_ip = '10.10.10.5'
  $load_balancer_ip = '10.10.10.5'
  $puppet_master_host_name = 'server1.example.com'
